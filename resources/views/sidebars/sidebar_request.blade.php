    ...
    <div class="sidebar">
        ...
        <div class="sidebar__body">
            ...
            <div class="sidebar__contents">
                ...
                <div class="sidebar__content" onClick="window.location='/home'">
                    <i class="fa fa-home" aria-hidden="true"></i>
                    <h2>Home</h2>
                </div>

                <div class="sidebar__content" onClick="window.location='/home/browse'">
                    <i class="fa fa-book" aria-hidden="true"></i>
                    <h2>Browse</h2>
                </div>

                <div class="sidebar__content active" onClick="window.location='/home/request'">
                    <i class="fa fa-paper-plane" aria-hidden="true"></i>
                    <h2>Request</h2>
                </div>

                <div class="sidebar__content" onClick="window.location='/home/contact'">
                    <i class="fa fa-phone-square" aria-hidden="true"></i>
                    <h2>Contact</h2>
                </div>

                <div class="sidebar__content" onClick="window.location='/home/settings'">
